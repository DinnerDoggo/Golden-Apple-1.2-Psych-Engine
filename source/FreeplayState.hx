...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			var songText:Alphabet = new Alphabet(80, (0 * i) + 280, songs[i].songName, true);
	...
	/*public function LoadProperPack() // scrapped function
	{
		switch (FreeplaySelectState.freeplayCats[FreeplaySelectState.curCategory].toLowerCase())
			{
				case 'main':
					addWeek(['Joyful', 'Seeking', 'Escape'], 0, 0xFFce3c80, ['gf']);
				case 'extra':
					addWeek(['Upon The Stars', 'Whats It To You', 'Lost'], 1, 0xff00c3ff, ['dad', 'dad', 'dad']);
				case 'funny':
					addWeek(['Chill', 'Bami Danger', 'Familiar'], 1, 0xff00c3ff, ['dad', 'dad', 'dad']);
			}
	}*/
