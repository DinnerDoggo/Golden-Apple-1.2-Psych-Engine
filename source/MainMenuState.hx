...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Golden Apple V" + psychEngineVersion, 12);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://docs.google.com/document/d/14XHPD53QQILlwTKla0aE5zvEqU9hiAqRw5D3g1QVKl0');
				}
				else
				{
					selectedSomethin = true;
						...
						else
						{
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								switch (daChoice)
								{
									...
									case 'shipping cute':
										PlayState.SONG = Song.loadFromJson('dave-x-bambi-shipping-cute', 'dave-x-bambi-shipping-cute');
