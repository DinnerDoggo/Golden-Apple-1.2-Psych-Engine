...
class MenuSongState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("In Songs Menu", null);
		#end
					...
					menuItems.forEach(function(spr:FlxSprite)
					{
						...
						else
						{
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								{
									case 'disruption':
										PlayState.SONG = Song.loadFromJson('disruption', 'disruption');
										LoadingState.loadAndSwitchState(new PlayState());
									case 'applecore':
										PlayState.SONG = Song.loadFromJson('applecore', 'applecore');
										LoadingState.loadAndSwitchState(new PlayState());
									case 'disability':
										PlayState.SONG = Song.loadFromJson('disability', 'disability');
										LoadingState.loadAndSwitchState(new PlayState());
									case 'wireframe':
										PlayState.SONG = Song.loadFromJson('wireframe', 'wireframe');
										LoadingState.loadAndSwitchState(new PlayState());
									case 'algebra':
										PlayState.SONG = Song.loadFromJson('algebra', 'algebra');
										LoadingState.loadAndSwitchState(new PlayState());
									case 'deformation':
										PlayState.SONG = Song.loadFromJson('deformation', 'deformation');
										LoadingState.loadAndSwitchState(new PlayState());
									case 'ferocious':
										PlayState.SONG = Song.loadFromJson('ferocious', 'ferocious');
										LoadingState.loadAndSwitchState(new PlayState());
									case 'extras':
