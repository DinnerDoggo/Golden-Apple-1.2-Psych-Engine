...
u can change the direction of the scroll by making the speed negative

also to change the value of xSpeed in a lua script do 



setShaderFloat("yourLuaSprite", "xSpeed", 20)



	shader found here: https://www.shadertoy.com/view/WtGGRt

   ty to M1 Aether for making the shader work better
